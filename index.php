...
<header>
    <div class="d-flex align-items-center p-2">
        ...
        <h2 class="d-inline-block">Privacy e Termini</h2>
    </div>

    <ul>
        <?php
// faccio un foreach per i link della pagina
        foreach($navLinks as $singleLink){
           ?> <li><a href="<?php echo $singleLink["href"] ?>"><?php echo $singleLink["title"] ?></a></li>
        <?php
        };
        ?>
    </ul>
